...
public class UIobjects {
	...
	public static String page_title_css = "#catalog-wrap > h1";
	
	//sort
	public static String low_high_css = "#sorting > div.pull-right > select > option:nth-child(2)";
	public static String high_low_css = "#sorting > div.pull-right > select > option:nth-child(3)";
	...
	public static String discount_css = "#shared-filter > div > div.sidebar > form > div:nth-child(2) > div.filter-box-heading.text-uppercase.text-bold > h2 > a";
	/*public static String d0-20_css = "#discount > span:nth-child(1) > label";
	public static String d20_40_css =

module Css
    ...
    {:name=>"options", :css => "#product-size > p > strong"},
    {:name => "size", :css => ".in-stock:nth-child(3) div"}, #size select
    #mini_cart
    ...
    {:name => "order_status", :css => "#orders-information > section > div:nth-child(1) > div.thanku-inner-header > div.bit-2.padding-zero.pull-left.text-left > p.text-capitalize > strong"},
    ...
    {:name => "order_placed_date", :css => "#orders-information > section > div:nth-child(1) > div.thanku-inner-header > div.bit-2.padding-zero.pull-left.text-left > p.margin-th-each.col-666.ng-binding"},
    {:name => "product_name", :css => "#orders-information > section > div:nth-child(1) > div.thanku-rows > div > div:nth-child(1) > div.order-image-details.bit-2-left-th.padding-zero.pull-left.text-left > div.order-desc.pull-left > p.margin-th-each.text-capitalize > a"},
    {:name => "total_amount", :css => "#orders-information > section > div:nth-child(1) > div.thanku-inner-header > div.bit-2.padding-zero.pull-right.text-right > p > span"},
     
    {:name => "old_password", :css => "#tabs > ul > li:nth-child(2) > a"},
    {:name => "notification", :css => "#account-wrap > div > div:nth-child(3) > div > a"},
    {:name => "notification_content", :css => "#notification-wrap > article > section > div:nth-child(1)"},
